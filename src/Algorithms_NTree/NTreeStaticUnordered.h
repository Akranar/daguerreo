#ifndef _N_TREE_STATIC_UNORDERED_H_
#define _N_TREE_STATIC_UNORDERED_H_
...
class NTreeStaticUnordered: public BASE
{
public:
...
class NTreeStaticUnordered<CHILDREN_COUNT, BASE, true>: public BASE
{
public:
	typedef BASE CHILDREN;
protected:
