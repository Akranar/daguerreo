...
//Added by Akranar 8/15/11
typedef tthread::mutex Mutex;
typedef tthread::recursive_mutex RecursiveMutex;
#define LockGuard tthread::lock_guard
typedef tthread::condition_variable ConditionVariable;
